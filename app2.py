...
def generate_map(df):
    ...
    legend_html = '<div style="position: fixed; bottom: 50px; left: 50px; width: 250px; background-color: white; border:2px solid black; z-index:9999; font-size:14px; color:#333333; padding:10px;">'
